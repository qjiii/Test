<?php
ob_start();
$API_KEY = "5981055972:AAEJrVM_6LR3Qp-cEVSzoxlcqZ3hPojSGYQ";#توكنك
$buy = "@E_X_J";#معرفك
$sudo = "1184904090";#ايديك
$admin = "1184904090";#ايديك
$idBot = "5981055972";#ايدي بوتك
$admmm = 1184904090;#ايديك
$Dev = array("1184904090", "" );#ايديك
$userrr = "iM7snBot";#معرف بوتك بدون @
...
$Dev = array("$admmm","5573109996");// حط ايدي مطور ثاني بدل الاصفار
$channel = "1184904090";
$token = API_KEY;
...
if($text =="السورس" || $text =="سورس"){
	...
	'chat_id'=>$chat_id,
	'text'=>"*┄─┅══┅─┄     
👋│اهلا بك في سورس الاسطورة ⚜
●ـ▬ـ▬ஜ۩۞۩ஜ▬ـ▬ـ●
📡╿*[قناة السورس العامة](t.me/tareq1979)*
⚜│*[قناة شروحات السورس](https://t.me/https://t.me/joinchat/AAAAAEjtH5wdyG7npso2hQ)*
🛒│*[فريق تطبيقات والعاب](https://t.me/https://t.me/joinchat/AAAAAEjtH5wdyG7npso2hQ) *
👨🏻‍✈️╽*[مطور السـورس](t.me/iiiiobot)*
●ـ▬ــ▬ஜ۩۞۩ஜ▬ـ▬ـ●
*",
    'disable_web_page_preview'=>true,
    'parse_mode'=>"MARKDOWN",
...
'text'=>"*🎖
🗂¦ تم تحديث الملفات √
🔘¦ للمزيد»* [اضغط هنا](t.me/tareq1979)*❕
▂
*",
'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true, 'reply_to_message_id'=>$message->message_id,
]);
...
",
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>"√ • تنصيب بوت مجاني • √",'url'=>"https://telegram.me/iiiiobot?start"]
              ] 
              ],
        ])
            ]);
